...
export default function HiddenNumerology() {
    ...
    return (
        <motion.div
            ...
            className="w-full max-w-6xl xl:max-w-[85%] 2xl:max-w-[90%] mx-auto backdrop-blur-xl bg-black/30 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 shadow-2xl shadow-purple-500/30 border border-purple-500/20"
            style={{
