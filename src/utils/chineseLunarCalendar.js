...
export function convertToChineseLunar(gregorianDate) {
    ...
    let chineseYear, chineseMonth, chineseDay;
    ...
    if (gregorianDateObj >= cnyDateObj && gregorianDateObj < nextCNYDateObj) {
        ...
        // This is a simplified version; actual lunar calendar is more complex
    ...
    return {
        ...
        month: chineseMonth,
        day: chineseDay,
        formatted: `${chineseYear}-${String(chineseMonth).padStart(2, '0')}-${String(chineseDay).padStart(2, '0')}`
    };
}
